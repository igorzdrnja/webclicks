...
export default function() {
  ...
  function computeNodeValues() {
    nodes.forEach(function(node) {
      ...
      //tweak for the users that are gone after the first step
      //because sankey calculates node values only by links
      if (typeof node.goneAfterFirstStep === "number") {
          node.value += node.goneAfterFirstStep;
      }
    });
  }
